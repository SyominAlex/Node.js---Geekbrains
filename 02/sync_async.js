...
// Запуск: node sync_async.js
// В консоль выведет: 1, 5, 6, 2, 3, 4
 ...
 * - т.к. очередь микротасков не пуста - выполнится cb и разрезолвится внутреннний промис и
 ...
 * 6) Record 4 - выполнится последний вызов из коллбэка промиса.
 */